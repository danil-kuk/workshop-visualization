...
export const statistic = {
  getProjectCompetenciesStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeProjectCompetenciesStatistic }), 1000)
    })
  },
  ...
  getStudentCompetenciesStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeStudentCompetenciesStatistic }), 1000)
    })
  },
  ...
  getKeyTechnologyStudentsStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeKeyTechnologyStudentsStatistic }), 1000)
    })
  },
  ...
  getKeyTechnologyCuratorsStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeKeyTechnologyCuratorsStatistic }), 1000)
    })
  },
  ...
  getKeyTechnologyConsumersStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeKeyTechnologyConsumersStatistic }), 1000)
    })
  },
  ...
  getProjectDistributionStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeProjectDistributionStatistic }), 1000)
    })
  },
  ...
  getKeyStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeKeyStatistic }), 1000)
    })
  },
  ...
  getTopCostumersStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeTopCustomersStatistic }), 1000)
    })
  },
  ...
  getProjectRolesTopStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeProjectRolesTopStatistic }), 1000)
    })
  },
  ...
  getTeamsCountOnCompetenciesStatistic: (eventId: number): Promise<any> => {
    ...
    return new Promise((resolve) => {
      setTimeout(() => resolve({ status: 200, data: fakeTeamsCountOnCompetenciesStatistic }), 1000)
    })
  },
}
